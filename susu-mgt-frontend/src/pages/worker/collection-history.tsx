                ...
                {isLoading ? (
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-24 text-center">
                      <History className="h-16 w-16 text-zinc-200 dark:text-zinc-800 mx-auto mb-6" />
                      <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">
                        No collections found
                      </h3>
                      <p className="text-zinc-500 dark:text-zinc-400">
                        You haven't processed any collections yet.
                      </p>
                    </td>
                  </tr>
                )}
