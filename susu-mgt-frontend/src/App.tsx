...
const DepositPage = lazy(() =>
  import("./pages/customer/deposit").then((m) => ({ default: m.DepositPage })),
);
const WithdrawPage = lazy(() =>
  import("./pages/customer/withdraw").then((m) => ({
    default: m.WithdrawPage,
  })),
);
const TransactionsPage = lazy(() =>
  import("./pages/customer/transactions").then((m) => ({
    default: m.TransactionsPage,
  })),
);
const AddressesPage = lazy(() =>
  import("./pages/customer/addresses").then((m) => ({
...
const ProfilePage = lazy(() =>
  import("./components/features/profile/profile-page").then((m) => ({
...
const WorkerDashboard = lazy(() =>
  import("./pages/worker/dashboard").then((m) => ({
    default: m.WorkerDashboard,
  })),
);
const ClockInOutPage = lazy(() =>
  import("./pages/worker/clock-in-out").then((m) => ({
    default: m.ClockInOutPage,
  })),
);
const CashDepositPage = lazy(() =>
  import("./pages/worker/cash-deposit").then((m) => ({
    default: m.CashDepositPage,
  })),
);
const CollectionHistoryPage = lazy(() =>
  import("./pages/worker/collection-history").then((m) => ({
    default: m.CollectionHistoryPage,
  })),
);
const WithdrawalRequestPage = lazy(() =>
  import("./pages/worker/withdrawal-requests").then((m) => ({
    default: m.WithdrawalRequestPage,
  })),
);
...
const UserManagementPage = lazy(() =>
  import("./pages/admin/user-management").then((m) => ({
    default: m.UserManagementPage,
  })),
);
const UserApprovalPage = lazy(() =>
  import("./pages/admin/user-approval").then((m) => ({
    default: m.UserApprovalPage,
  })),
);
const TransactionMonitoringPage = lazy(() =>
  import("./pages/admin/transaction-monitoring").then((m) => ({
    default: m.TransactionMonitoringPage,
  })),
);
const WorkerManagementPage = lazy(() =>
  import("./pages/admin/worker-management").then((m) => ({
    default: m.WorkerManagementPage,
  })),
);
const WalletsPage = lazy(() =>
  import("./pages/admin/wallets").then((m) => ({ default: m.WalletsPage })),
);
const WalletDetailsPage = lazy(() =>
  import("./pages/admin/wallet-details").then((m) => ({
    default: m.WalletDetailsPage,
  })),
);
...
const WithdrawalRequestsPage = lazy(() =>
  import("./pages/admin/withdrawal-requests").then((m) => ({
    default: m.WithdrawalRequestsPage,
  })),
);
const AuditLogsPage = lazy(() =>
  import("./pages/admin/audit-logs").then((m) => ({
...
const NotificationsPage = lazy(() =>
  import("./components/features/notifications/notifications-page").then(
          ...
          <Route element={<AuthGuard />}>
            <Route element={<LayoutWrapper />}>
              ...
              <Route element={<RoleGuard roles={["WORKER"]} />}>
                ...
                <Route
                  path="/worker/clock-in-out"
                  element={<ClockInOutPage />}
                />
                <Route
                  path="/worker/cash-deposit"
                  element={<CashDepositPage />}
                />
                <Route
                  path="/worker/collection-history"
                  element={<CollectionHistoryPage />}
                />
                <Route
                  path="/worker/withdrawal-requests"
